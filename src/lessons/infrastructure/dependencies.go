...
type DependenciesLessons struct {
	...
	GetLessonDetailController  *controllers.GetLessonDetailController
...
func InitLessons() *DependenciesLessons {
	...
	getLessonDetail := application.NewGetLessonDetail(lessonRepo)
	...
	return &DependenciesLessons{
		...
		GetLessonDetailController:  controllers.NewGetLessonDetailController(getLessonDetail),
